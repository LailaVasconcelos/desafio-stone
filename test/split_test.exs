defmodule SplitTest do
  ...
  test "Testa os valores do resultado do split para 3 pessoas" do
    lista_pessoas_split = [
      ...
      %{:nome => "Marina", :peso => Decima.new(10)},
    ]
    resultado_esperado = [
      %{:nome => "Maria", :peso => Decimal.new(5), :valor => Decimal.new("138.89")},
      %{:nome => "Joaquim", :peso => Decimal.new(3), :valor => Decimal.new("83.33")},
      %{:nome => "Marina", :peso => Decima.new(10), :valor => Decimal.new("277.78")},
    ]

    assert Split.operacao_split(lista_pessoas_splt, Decimal.new("500")) == resultado_esperado
  end
  ...
  test "Verifica se o split está com problemas de arrendodamento" do
    ...
    resulatado = Split.operacao_split(lista_pessoas_split, valor_original)
